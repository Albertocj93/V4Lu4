...
public partial class ExportarExcelPuestos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        oLista = PuestoBL.ExportarByUser(connstring,CuentaUsuario);

        string nombreReport = "VALUA_" + DateTime.Now.Day + "_" + DateTime.Now.Month + "_" + DateTime.Now.Year;
        ...
        columnas.Add(new ReportColumnHeader() { BindField = "UsuarioModificacion", HeaderName = "Usuario Modificador" });
        columnas.Add(new ReportColumnHeader() { BindField = "Comentario", HeaderName = "Comentario" });
        columnas.Add(new ReportColumnHeader() { BindField = "FechaModificacion", HeaderName = "Fecha de Modificación" });
        ...
        ExportExcel.List2Excel2(Context.Response, oLista, "Evaluación de puestos", nombreReport, columnas);
